...
for r in cl.find({'_id':{'$in':golden.keys()}}):
	print r['_id'], norm(r['entropy']/max_entropy), norm(r['sharpness']/max_sharpness), norm(r['colorfulness']/max_colorfulness), norm(1.0*r['shape'][0]*r['shape'][1]/max_area), (1 if golden[r['_id']] == 'high' else 0)
	#print r['_id'], norm(r['entropy']/max_entropy), norm(r['sharpness']/max_sharpness), norm(r['colorfulness']/max_colorfulness), norm(1.0*r['shape'][0]/max_length), norm(1.0*r['shape'][1]/max_length), (1 if golden[r['_id']] == 'high' else 0)
